...
- Add **Environment Variables**:
  ...
  | `IMAGE_DAILY_LIMIT` | *(optional)* max AI images per day (default **40**). Each photo makes **6** sticker images, so 40 ≈ 6 photo uploads + a few backgrounds. Stored in `usage/image-<date>.json`, resets at UTC midnight. Set to `0` to disable the cap. |
